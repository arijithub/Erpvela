 @extends('layouts.LayoutMaster1')
       ...
       <div id="page-wrapper">
            ...
            <!-- Customer details -->
             ...
             <?php } ?>
             <?php if(Request::segment(1)=='proedit1'){ ?>
...
<div class="col-md-12">
           <label class="radio-inline">
      <input type="radio" name="optradio" id="r1" onchange="rch1()" value="tax invoice" <?php if($mids->qtype=='tax invoice'){echo "checked"; } ?>>Tax Invoice
    </label>
    <label class="radio-inline">
      <input type="radio" name="optradio" id="r2" onchange="rch1()" value="proforma invoice" <?php if($mids->qtype=='proforma invoice'){echo "checked"; } ?>>Proforma Invoice
    </label>
    <label class="radio-inline">
      <input type="radio" name="optradio" id="r3" onchange="rch1()" value="quotation" <?php if($mids->qtype=='quotation'){echo "checked"; } ?>>Quotation
    </label>
  </div>
   ...
   <input type="hidden" class="form-control" id="tp1" name="quot1" value="<?php echo $mids->rpn; ?>">
  ...
  foreach ($users as $user) { ?>
    ...
    <?php }
                        ...
                        if(isset($proins)){ 
                          ...
                          <input type="hidden" name="hidjan" value="<?php echo $prus->pid; ?>">
                           ...
                           <tbody>
                             <?php 
                                 ...
                                 foreach ($proj as $userpro) { 
                                   foreach($upac as $up){
                                  if($userpro->prod_name!=$up->prod_name){
                                  ?>
                                    <tr class="odd gradeX">
                                        <td><?php echo $p++; ?></td>
